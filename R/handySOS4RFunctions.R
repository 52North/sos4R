...
phenomena <- function(sos, includeTemporalBBox=FALSE, listSites=FALSE) {
...
# siteList(sos, listPhenomena=T|F, includeTemporalBBox=T|F, ...)
...
# ~ us.2.4: List all sites with metadata ####
# sites(sos, listPhenomena=F, includeTemporalBBox=F) = sites(sos)
# → see us.2.1/us.2.2
#
# sites(sos, listPhenomena=T, includeTemporalBBox=F)
# → SpatialPointsDataFrame[siteID, phen_1=logical, …, phen_n=logical]
#
# sites(sos, listPhenomena=T, includeTemporalBBox=T)
