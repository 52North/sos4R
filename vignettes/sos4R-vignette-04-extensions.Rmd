...
Converters may be matched by XML properties `swe:Quatity[@definition]` or `swe:uom[@code]`.
...
```{r converters3f}
attributes(sosResult(data)[["http://www.52north.org/test/observableProperty/1"]])
```
