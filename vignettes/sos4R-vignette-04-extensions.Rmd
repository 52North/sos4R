...
The next example shows how the response (in this case the request is intentionally incorrent and triggers an exception) is passed through as an object of class `xml_document`:
