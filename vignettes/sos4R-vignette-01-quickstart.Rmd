...
```{r mySOS}
mySOS <- SOS(url = "http://sensorweb.demo.52north.org/sensorwebtestbed/service/kvp", binding = "KVP", useDCPs = FALSE)
```
...
Not all combinations off procedure, observed property and event time will deliver a result, but the following one should.
