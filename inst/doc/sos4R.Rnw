...
A good and extensive introduction into the whole field of SWE, including its history, and an analysis of the current state of the art and future developments is provided in a recent paper (Br?ring, 2011).
...
The start of the project was generously supported by the \fivetwon Student Innovation Prize for Geoinformatics 2010.
