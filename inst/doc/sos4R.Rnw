...
<<describeSensor,echo=TRUE,print=TRUE,cache=TRUE>>= 
...
obs.lastWeek.fois <- getObservation(sos = mySOS,
...
\item[weathersos] Time series analysis demo with weather data by ifgi.
\end{description}
